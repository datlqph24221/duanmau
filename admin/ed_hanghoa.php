...
<h2 class="text-center bg-light text-success">Sửa loại</h2> 
  ...
  <form action="" method="post" enctype="multipart/form-data" >
    ...
    <label >Mã hh:</label>
            <input type="text" class="form-control" name="ma_hh" placeholder="<?php echo $ma_hh ?>" readonly>
            ...
            <label >Hình:</label>
            <input type="file" class="form-control" name="img" value="<?php echo $img ?>" required>
